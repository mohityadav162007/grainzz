...
import { LayoutDashboard, Package, ShoppingBag, Tag, Star, LogOut, Menu, X, Home, BarChart3, MessageSquare, Settings, Ticket, Inbox, Truck, Filter, User } from 'lucide-react';
