          ...
          <div className="flex-1 w-full min-w-0">
            ...
            {loading && products.length === 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-[80px] text-center">
                <h3 className="text-[22px] font-bold text-brand-black mb-2">No combos found</h3>
                <p className="text-[15px] text-[#707070]">Check back soon for great bundle deals!</p>
              </div>
            ) : (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-[20px] md:gap-[24px]">
        ...
        <div className="fixed inset-0 z-50 flex justify-end lg:hidden">
          ...
          <div className="relative w-[300px] max-w-[85vw] h-full bg-white flex flex-col animate-slide-in-right shadow-xl">
            ...
            <div className="p-[20px] border-t border-[#E8E8E8] flex gap-[10px]">
              <button onClick={() => { setSelectedCategories(['Combos']); setExcludeOutOfStock(false); }} className="flex-1 py-[12px] border border-brand-black text-brand-black rounded-full font-bold text-[14px]">Clear</button>
