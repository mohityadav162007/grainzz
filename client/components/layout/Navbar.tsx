          ...
          <div className="max-w-[1440px] mx-auto h-[80px] relative">
            ...
            <div className="hdr-layer hdr-compact">
              <div className="flex-1 flex items-center justify-start gap-8">
                ...
                <Link href="/b2b" className={clsx('text-[15px] font-medium transition-all relative group', pathname === '/b2b' ? 'text-brand-green underline decoration-2 underline-offset-8' : 'text-[#222] hover:underline decoration-2 underline-offset-8')}>Gifting</Link>
